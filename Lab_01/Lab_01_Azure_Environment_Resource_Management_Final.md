...
These eight visuals are part of **Lab 01** and focus strictly on the Azure environment, Azure Resource Manager, resource groups, regions, availability zones, tags, deployment investigation, and Azure RBAC/access troubleshooting.

> **GitLab storage:** Save the eight PNG files in the `Lab_01_Images/` folder beside this Markdown file. The links below use relative paths so they render correctly when the folder is pushed to GitLab.

---

## INFOGRAPHIC 1 — Azure Resource Hierarchy

![Lab 01 — Azure Resource Hierarchy](./Lab_01_Images/01-azure-resource-hierarchy.png)

**Use this before Part 0 — Azure Resource Hierarchy.**

---

## INFOGRAPHIC 2 — Azure Regions & Availability Zones

![Lab 01 — Azure Regions and Availability Zones](./Lab_01_Images/02-azure-regions-availability-zones.png)

**Use this before the Region and Availability Zone exercise.**

---

## INFOGRAPHIC 3 — Create & Manage an Azure Resource Group

![Lab 01 — Create and Manage an Azure Resource Group](./Lab_01_Images/03-azure-resource-group-creation.png)

**Use this before the Azure Portal and Azure CLI resource-group exercise.**

---

## INFOGRAPHIC 4 — Azure Resource Tagging Strategy

![Lab 01 — Azure Resource Tagging Strategy](./Lab_01_Images/04-azure-resource-tagging-strategy.png)

**Use this before the tagging exercise and tag validation commands.**

---

## INFOGRAPHIC 5 — Azure Resource Management Troubleshooting

![Lab 01 — Azure Resource Management Troubleshooting](./Lab_01_Images/05-azure-resource-troubleshooting.png)

**Use this before the troubleshooting section.**

---

# 🚨 REAL-WORLD AZURE INCIDENT INFOGRAPHICS

These three visuals represent the hands-on incidents students investigate after completing the core Azure resource-management tasks.

---

## INCIDENT 01 — Where Did My Azure Resource Go?

![Lab 01 Incident 01 — Azure Resource Not Found](./Lab_01_Images/incident-01-resource-not-found.png)

**Scenario:** The resource exists somewhere in Azure, but the developer cannot find it in `rg-contoso-dev`.

**Investigation path:** `Subscription → Resource Group → Resource → Deployment / Access`

---

## INCIDENT 02 — Azure Resource Group Deployment Failed

![Lab 01 Incident 02 — Azure Deployment Failed](./Lab_01_Images/incident-02-deployment-failed.png)

**Scenario:** Creation of `rg-contoso-dev` fails and the engineer must inspect deployment status and error details before retrying.

**Investigation path:** `Deployment Status → Error Details → Subscription → Region → Resource Group → Permissions → Correct → Redeploy → Validate`

---

## INCIDENT 03 — Access Denied / Azure RBAC

![Lab 01 Incident 03 — Azure RBAC Access Denied](./Lab_01_Images/incident-03-access-denied-rbac.png)

**Scenario:** `rg-contoso-dev` exists, but an engineer cannot perform the required action.

**Investigation path:** `Identity → RBAC Role → Assignment Scope → Permissions → Action → Retest`

---

> ### Azure Engineering Rule
>
> **The diagrams are visual aids; the executable Azure Portal paths, Azure CLI commands, Bicep templates, validation steps, and troubleshooting procedures in this lab are the authoritative hands-on instructions.**
...
| Visual | Azure topic | Recommended point in lab |
|---|---|---|
| 01 | Tenant → Subscription → Resource Group → Resources | Before Resource Hierarchy |
| 02 | Region → Availability Zones | Before Region/AZ exercise |
| 03 | Portal + CLI resource-group creation | Before creation exercise |
| 04 | Azure tags and organization | Before tagging exercise |
| 05 | Azure resource troubleshooting | Before troubleshooting |
| Incident 01 | Resource not found | Real-world incident 1 |
| Incident 02 | Deployment failure | Real-world incident 2 |
| Incident 03 | RBAC / access denied | Real-world incident 3 |
