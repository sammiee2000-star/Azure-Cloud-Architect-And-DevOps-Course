...
The following visual infographic is a companion to Lab 01 and is **strictly focused on the Azure environment and activities covered by this lab**. It covers the Azure resource hierarchy, region and Availability Zone concepts, tagging, and the Portal/CLI/Bicep implementation used in the lab.

![Lab 01 — Azure Environment & Resource Management](./lab-01-azure-environment-resource-management-infographic.png)
...
### Infographic 2 — Azure Region & Availability Zones
...
### Infographic 3 — Azure Resource Tagging
...
> The infographic is a visual companion. The executable commands, exact Portal procedures, validation steps, and official Microsoft references remain authoritative in the sections below.
